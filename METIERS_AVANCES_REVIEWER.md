...
ALTER TABLE OUSSAMA.REVIEWER ADD CHARGE_TRAVAIL NUMBER(2) DEFAULT 0;
ALTER TABLE OUSSAMA.REVIEWER ADD TEMPS_MOYEN_REPONSE NUMBER(4) DEFAULT 0;
ALTER TABLE OUSSAMA.REVIEWER ADD TAUX_ACCEPTATION NUMBER(3,2) DEFAULT 0;
ALTER TABLE OUSSAMA.REVIEWER ADD QUALITE_RAPPORT NUMBER(3,2) DEFAULT 0;
ALTER TABLE OUSSAMA.REVIEWER ADD DATE_DERNIERE_EVALUATION DATE;
ALTER TABLE OUSSAMA.REVIEWER ADD STATUT_DISPONIBILITE NUMBER(1) DEFAULT 1;
ALTER TABLE OUSSAMA.REVIEWER ADD NIVEAU_EXPERTISE NUMBER(1) DEFAULT 2;
ALTER TABLE OUSSAMA.REVIEWER ADD DOMAINES_EXPERTISE CLOB;
```
