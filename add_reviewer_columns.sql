...
UPDATE OUSSAMA.REVIEWER SET SCOREFIABILITE = 0.0 WHERE SCOREFIABILITE IS NULL;
UPDATE OUSSAMA.REVIEWER SET IDPUBLICATION = NULL WHERE IDPUBLICATION IS NULL;

-- Vérifier que les colonnes ont été ajoutées
DESCRIBE OUSSAMA.REVIEWER;
