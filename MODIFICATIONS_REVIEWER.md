...
Avant :
```sql
SELECT IDREVIEWER, NOM, MAIL, SPECIALITE, AFFILIATION, NBEVALUATION FROM ADAM.REVIEWER
```
Après :
```sql
SELECT IDREVIEWER, NOM, MAIL, SPECIALITE, AFFILIATION, NBEVALUATION, SCOREFIABILITE, IDPUBLICATION FROM ADAM.REVIEWER
```
...
Avant :
```sql
INSERT INTO ADAM.REVIEWER (IDREVIEWER, NOM, MAIL, SPECIALITE, AFFILIATION, NBEVALUATION) 
VALUES (:id, :nom, :mail, :specialite, :affiliation, :nbEval)
```
Après :
```sql
INSERT INTO ADAM.REVIEWER (IDREVIEWER, NOM, MAIL, SPECIALITE, AFFILIATION, NBEVALUATION, SCOREFIABILITE) 
...
Avant :
```sql
UPDATE ADAM.REVIEWER SET NOM = :nom, MAIL = :mail, SPECIALITE = :specialite, 
